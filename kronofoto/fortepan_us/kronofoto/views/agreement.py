...
from fortepan_us.kronofoto.models.archive import ArchiveAgreement, UserAgreement
...
from fortepan_us.kronofoto.forms import AgreementForm
...
class AgreementDetailView(DetailView):
    ...
    template_name = "kronofoto/pages/agreement/agreement_detail.html"
...
class BaseAgreementView(View):
    ...
    template_name = 'kronofoto/pages/agreement/archiveagreement_detail.html'
...
class UserAgreementCheckRedirect(UserAgreementCheck):
    pattern_name = "kronofoto:agreement"

class KronofotoTemplateView(BaseTemplateMixin, TemplateView):
    template_name = 'kronofoto/pages/agreement/anonymous_agreement.html'
