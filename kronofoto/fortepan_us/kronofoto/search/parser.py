...
photographerExactExpr = parsy.string('photographer_exact:') >> string.map(PhotographerExactly)
...
hasPhotoSphereExpr = parsy.string('has_mainstreet:') >> boolean.map(HasPhotoSphere)
