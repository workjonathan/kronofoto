# Generated by Django 3.2.19 on 2023-09-07 05:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('kronofoto', '0059_alter_photo_caption'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archive', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='kronofoto.archive')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agreement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kronofoto.archiveagreement')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=fortepan_us.kronofoto.models.photo.get_submission_path)),
                ('archive', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='kronofoto.archive')),
                ('donor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='kronofoto.donor')),
                ('scanner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='archive_submission_scanned', to='kronofoto.donor')),
