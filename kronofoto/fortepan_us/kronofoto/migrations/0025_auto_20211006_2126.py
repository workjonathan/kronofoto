...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('kronofoto', '0024_auto_20210923_2008'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='photo',
            name='original',
            field=models.ImageField(null=True, storage=fortepan_us.kronofoto.storage.OverwriteStorage(), upload_to=fortepan_us.kronofoto.models.get_original_path),
        ),
        migrations.AlterField(
            model_name='photo',
            name='year',
