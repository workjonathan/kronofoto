...
urlpatterns : List[Union[URLPattern, URLResolver]] = [
    ...
    path('materials/<slug:category>/<accession:pk>/original', views.DownloadPageView.as_view(), name='download'),
    path('materials/all/<accession:pk>/original', views.DownloadPageView.as_view(), name='download'),
    ...
    path('photos/<accession:photo>', views.PhotoView.as_view(category='photos')),
    ...
    path('materials/all/year:<int:year>', YearRedirect.as_view(), name="year-redirect"),
    path('materials/<slug:category>/year:<int:year>', YearRedirect.as_view(), name="year-redirect"),
    ...
    path('photo/<accession:photo>/tag-members/edit', views.AddTagView.as_view()),
    path('materials/all/<accession:photo>/tag-members/edit', views.AddTagView.as_view(), name='addtag'),
    path('materials/<slug:category>/<accession:photo>/tag-members/edit', views.AddTagView.as_view(), name='addtag'),
