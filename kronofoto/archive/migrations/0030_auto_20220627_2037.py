...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('archive', '0029_photo_location_from_google'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(null=True, storage=archive.storage.OverwriteStorage(), upload_to=archive.models.get_photosphere_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ForeignKey(help_text='Select a photo and photo sphere then click Save and Continue Editing to use the interactive tool', on_delete=django.db.models.deletion.CASCADE, to='archive.photo')),
