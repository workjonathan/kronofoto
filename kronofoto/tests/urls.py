...
from .test_agreement import AgreementFormView, Agreement, UserAgreementCheck
testpatterns = [
    path('postagreement/<int:pk>', AgreementFormView.as_view(model=Agreement, template_name='tests/agreement.html'), name="tests/agreement.html"),
