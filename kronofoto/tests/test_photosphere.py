...
@given(
    ...
    photo_url=st.builds(Mock, return_value=st.text(max_size=10)),
    view=st.builds(
...
def test_photosphere_json_response(view, object, photo, links, related_photosphere_pairs, infoboxes, image_url, dimensions, photo_url):
    view.object = object
    view.links = links
